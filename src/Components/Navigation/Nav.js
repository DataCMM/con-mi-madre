...
const Nav = () => {
  return (
    <div className="flex space-x-6 text-gray-500 text-base hidden md:contents text-md lg:text-md xl:text-lg">
      <div className="z-10 flex flex-row items-center inline-block hover:text-green-400">
      ...
      <Link
        to="/Donate"
        className="z-10 text-white px-2 rounded shadow-xl text-center bg-green-400 hover:text-green-400 hover:bg-white"
      >
        Donate
      </Link>
    </div>
