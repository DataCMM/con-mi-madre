...
import CMMLogo from "../../images/stacked/trimmed-color-and-white.png";
  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex flex-none self-center pt-5 h-1/2 w-1/2 md:self-start md:mt-10 md:ml-10 md:h-1/5 md:w-1/5 bg-opacity-0">
          <img
            // style={{ maxWidth: "65%" }}
            src={CMMLogo}
        ...
        <div className="z-10 flex flex-col pb-48 pt-10 text-gray-500 text-2xl font-bold tracking-widest text-center sm:text-xl md:text-4xl md:pt-20 lg:text-5xl lg:pt-10">
