  ...
  return (
    <>
      ...
      <div className="flex flex-col pt-10 pb-10 gap-6 md:grid-cols-2 lg:grid-cols-3 bg-gray-500 md:p-12">
        <button className="w-3/4 m-auto text-center p-5 h-32 bg-blue-500 text-gray-500">
          <h3 className="pb-2">$50</h3>
          <p>To buy school uniforms for scholars that need them.</p>
        </button>
        <button className="w-3/4 m-auto text-center p-5 h-36 bg-blue-500 text-gray-500">
          <h3 className="pb-2">$150</h3>
          <p>
            To purchase school supplies for every scholar to prevent the need to
            share.
          </p>
        </button>
        <button className="w-3/4 m-auto text-center p-5 h-36 bg-blue-500 text-gray-500">
          <h3 className="pb-2">$250</h3>
          <p>
            For personal protective equipment and cleaning supplies to keep
            everyone in the buibuttonafe.
          </p>
        </button>
        <button className="w-3/4 m-auto text-center p-5 h-36 bg-blue-500 text-gray-500">
          <h3 className="pb-2">$500</h3>
          <p>
            To purchase Chromebooks so that each scholar has a digital device to
            prevent educatbuttonaps while learning at home
          </p>
        </button>
        <button className="w-3/4 m-auto text-center p-5 h-36 bg-blue-500 text-gray-500">
          <h3 className="pb-2">$1000</h3>
          <p>
      ...
      <div className="text-center p-5">
        ...
        <button className="bg-blue-500 text-gray-500 p-5">
