...
export default function Modal({ member }) {
  ...
  return (
    <>
      <button
        className="pt-2 font-semibold text-sm text-center md:text-left hover:text-pink-500 outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
        type="button"
